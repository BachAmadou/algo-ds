// LINK TO CODEPEN VERSION: https://codepen.io/816978819/pen/ZwOdBx

// Implement classes Node and Linked List

class Node {
	constructor(data, nextValue) {
		this.data = data,
...
class LinkedList {
	...
	// shift() is used to "remove" the first node element of a linked list
	shift() {
		if(!this.head) {
			return;
		}
	...
	// pop() is used to "remove" the last node element of a linked list
