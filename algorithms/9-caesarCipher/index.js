...
// LINK TO CODEPEN VERSION: https://codepen.io/816978819/pen/MLrVor
...
function caesarCipher(str, shift) {
  ...
  for(let i = 0; i < str.length; i++) {
    ...
    if(index === -1) {
      res += char;
      continue; // what the "continue" keyword does is, it will not allow anymore code to run after "coutinue"
    }

    const codedIdx = (index + shift) % 26;
    res += alphabetArr[codedIdx];
  }
  return res;
}
